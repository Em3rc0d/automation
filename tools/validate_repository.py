...
REQUIRED_PATHS = [
    ...
    "mk0/README.md",
    "mk1/README.md",
    ".github/workflows/mk1-one-command-launch-validation.yml",
    "operations/savings/MK1-ONE-COMMAND-LAUNCH.md",
    "tools/savings/launch_pilot.py",
    ".github/workflows/mk1-evidence-sync-validation.yml",
    "operations/savings/schemas/mk1-ops-evidence.schema.json",
    "operations/savings/MK1-EVIDENCE-SYNC.md",
    "tools/savings/mk1_evidence_sync.py",
    ".github/workflows/mk1-pilot-intake-validation.yml",
    "operations/savings/MK1-PILOT-INTAKE.md",
    "tools/savings/pilot_intake.py",
    ".github/workflows/mk1-prepilot-validation.yml",
    "operations/savings/examples/mk1-pilot-evidence.blocked.example.json",
    "operations/savings/schemas/mk1-pilot-evidence.schema.json",
    "operations/savings/MK1-REAL-PILOT-GATE.md",
    "tools/savings/mk1_gate.py",
    "tools/savings/tests/test_render_rehearsal_html.py",
    ...
    ".github/workflows/mk1-ops-hardening-validation.yml",
    "operations/savings/runtime/test/incident-drill.test.mjs",
    "operations/savings/runtime/incident_drill.mjs",
    "tools/savings/tests/test_backup_bundle.py",
    "tools/savings/backup_bundle.py",
    "mk1/ops-hardening/README.md",
    ".github/workflows/mk1-rehearsal-validation.yml",
    "tools/savings/tests/test_rehearse_pilot.py",
    "tools/savings/rehearse_pilot.py",
    "mk1/rehearsal/pilot-plan.json",
    "mk1/rehearsal/README.md",
    "mk1/STATUS.md",
    "runtime/README.md",
