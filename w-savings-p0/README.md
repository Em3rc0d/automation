...
+ 4 provider-neutral local adapters
...
- evidence SHA: `8475fcd95817098c59cd1088b543e4881bd3fe38`
- Baseline Factory run: `36087356818`
- Node: `20.19.5`
- tests: **44/44 PASS**
- certificate: `certification/F1-ZERO-DEPS-NODE-V1-CERTIFICATE.md`

Runtime certification is intentionally separate from workflow lifecycle promotion.
...
- [x] create table/message/calendar/storage local adapters;
...
- [x] certify `zero-deps-node-v1` in Baseline Factory;
