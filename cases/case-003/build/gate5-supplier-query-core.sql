-- CASE-003 Gate 5 portable PostgreSQL core.
-- Identity -> verified channel -> active membership -> permission -> resource ownership -> invoice result.
-- No Supabase/PostgREST roles are referenced here.
...
create or replace function case003.supplier_invoice_query_direct(
  p_tenant_id uuid,
  p_channel text,
  p_subject text,
  p_invoice_reference text,
