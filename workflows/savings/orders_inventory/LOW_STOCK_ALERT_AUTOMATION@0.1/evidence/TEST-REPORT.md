...
workflow_test: runtime/savings-p0/test/low-stock-alert.test.js
workflow_demo: runtime/savings-p0/demo/low-stock-alert/run.js
idempotency: PASS
failure_paths: PASS
tenant_scope: PASS
savings_event: PASS
...
- workflow: `LOW_STOCK_ALERT_AUTOMATION@0.1`
- domain: `orders_inventory`
- implementation: `runtime/savings-p0/src/workflows/low-stock-alert.js`
