# Runbook — Inventory Synchronization

Monitor success/failure, last success, connector health, automated `inventory movement`, exceptions, variable cost and incidents.
