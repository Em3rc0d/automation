# Runbook — Accounting Document Normalization

Monitor success/failure, last success, connector health, automated `document`, exceptions, variable cost and incidents.
