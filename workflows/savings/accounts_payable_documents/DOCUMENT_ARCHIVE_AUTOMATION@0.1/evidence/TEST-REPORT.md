...
workflow_test: runtime/savings-p0/test/document-archive.test.js
workflow_demo: runtime/savings-p0/demo/document-archive/run.js
idempotency: PASS
failure_paths: PASS
tenant_scope: PASS
savings_event: PASS
...
- workflow: `DOCUMENT_ARCHIVE_AUTOMATION@0.1`
- domain: `accounts_payable_documents`
- implementation: `runtime/savings-p0/src/workflows/document-archive.js`
