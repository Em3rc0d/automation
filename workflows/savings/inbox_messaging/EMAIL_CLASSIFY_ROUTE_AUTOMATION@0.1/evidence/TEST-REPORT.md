# Test Report — Email Classification and Routing
...
workflow_test: runtime/savings-p0/test/email-classify-route.test.js
workflow_demo: runtime/savings-p0/demo/email-classify-route/run.js
idempotency: PASS
failure_paths: PASS
tenant_scope: PASS
savings_event: PASS
...
- workflow: `EMAIL_CLASSIFY_ROUTE_AUTOMATION@0.1`
- domain: `inbox_messaging`
- implementation: `runtime/savings-p0/src/workflows/email-classify-route.js`
