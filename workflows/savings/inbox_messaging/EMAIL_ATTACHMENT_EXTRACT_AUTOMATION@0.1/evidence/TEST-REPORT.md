# Test Report — Email Attachment Extraction
...
workflow_test: runtime/savings-p0/test/email-attachment-extract.test.js
workflow_demo: runtime/savings-p0/demo/email-attachment-extract/run.js
idempotency: PASS
failure_paths: PASS
tenant_scope: PASS
savings_event: PASS
...
- workflow: `EMAIL_ATTACHMENT_EXTRACT_AUTOMATION@0.1`
- domain: `inbox_messaging`
- implementation: `runtime/savings-p0/src/workflows/email-attachment-extract.js`
