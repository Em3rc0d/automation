...
- workflow-specific test: `runtime/savings-p0/test/email-attachment-extract.test.js`
- deterministic demo: `runtime/savings-p0/demo/email-attachment-extract/run.js`
