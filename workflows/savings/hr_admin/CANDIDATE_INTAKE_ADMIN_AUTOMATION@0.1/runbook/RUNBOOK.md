# Runbook — Candidate Intake Administration

Monitor success/failure, last success, connector health, automated `candidate`, exceptions, variable cost and incidents.
