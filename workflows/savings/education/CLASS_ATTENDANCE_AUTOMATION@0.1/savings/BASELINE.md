# Savings Baseline — Class Attendance Registration

Primary unit: **student/class**

Manual work reduced: Convert attendance/meeting records into the attendance register.
