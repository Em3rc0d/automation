# Runbook — Class Attendance Registration

Monitor success/failure, last success, connector health, automated `student/class`, exceptions, variable cost and incidents.
