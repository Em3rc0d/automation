...
workflow_test: runtime/savings-p0/test/support-intake.test.js
workflow_demo: runtime/savings-p0/demo/support-intake/run.js
idempotency: PASS
failure_paths: PASS
tenant_scope: PASS
savings_event: PASS
...
- workflow: `SUPPORT_INTAKE_AUTOMATION@0.1`
- domain: `support`
- implementation: `runtime/savings-p0/src/workflows/support-intake.js`
