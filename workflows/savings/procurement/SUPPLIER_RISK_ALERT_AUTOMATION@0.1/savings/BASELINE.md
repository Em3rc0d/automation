# Savings Baseline — Supplier Risk Alert

Primary unit: **supplier**

Manual work reduced: Check configured supplier-risk sources and alert only on relevant changes.
