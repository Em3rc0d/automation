# Test Report — Lead Intake Automation
...
workflow_test: runtime/savings-p0/test/lead-intake.test.js
workflow_demo: runtime/savings-p0/demo/lead-intake/run.js
idempotency: PASS
failure_paths: PASS
tenant_scope: PASS
savings_event: PASS
...
- workflow: `LEAD_INTAKE_AUTOMATION@0.1`
- domain: `sales_leads`
- implementation: `runtime/savings-p0/src/workflows/lead-intake.js`
