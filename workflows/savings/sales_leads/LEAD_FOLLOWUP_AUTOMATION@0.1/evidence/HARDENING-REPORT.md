# Hardening Report — Lead Follow-up
...
- workflow: `LEAD_FOLLOWUP_AUTOMATION@0.1`
- domain: `sales_leads`
...
- [x] SavingsBaseline unit is `follow-up` and is not decomposed into overlapping reducer claims;
