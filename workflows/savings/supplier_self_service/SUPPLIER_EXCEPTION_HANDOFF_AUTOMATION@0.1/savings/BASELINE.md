# Savings Baseline — Supplier Exception Handoff

Primary unit: **exception**

Manual work reduced: Create a human task only when the self-service flow cannot safely resolve the request.
