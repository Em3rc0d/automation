# Runbook — Supplier Status Change Notification

Monitor success/failure, last success, connector health, automated `status change`, exceptions, variable cost and incidents.
