# Savings Baseline — Supplier Status Change Notification

Primary unit: **status change**

Manual work reduced: Detect important status changes and notify the supplier proactively.
